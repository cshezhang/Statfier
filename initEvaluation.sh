...
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/SpotBugs_30/
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/SpotBugs_60/
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/SpotBugs_120/
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/SpotBugs_180/
cp ./clean.sh ~/evaluation/SpotBugs_15/
cp ./clean.sh ~/evaluation/SpotBugs_30/
...
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/PureRandom_SpotBugs_120/
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/PureRandom_SpotBugs_180/
cp ./clean.sh ~/evaluation/PureRandom_SpotBugs_15/
cp ./clean.sh ~/evaluation/PureRandom_SpotBugs_30/
...
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/GuidedRandom_SpotBugs_120/
cp  ./out/artifacts/SAMutator/SAMutator.jar ~/evaluation/GuidedRandom_SpotBugs_180/
cp ./clean.sh ~/evaluation/GuidedRandom_SpotBugs_15/
cp ./clean.sh ~/evaluation/GuidedRandom_SpotBugs_30/
