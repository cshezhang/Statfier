...
public class SpotBugsInvoker implements Runnable {

    private String seedFolderPath;
    private String seedFolderName;
    private List<String> seedFileNamesWithSuffix;

    public SpotBugsInvoker(String seedFolderPath, String seedFolderName, List<String> seedFileNamesWithSuffix) {
