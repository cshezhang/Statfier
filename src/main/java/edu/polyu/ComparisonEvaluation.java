...
import static edu.polyu.report.PMDReport.readSinglePMDResultFile;
import static edu.polyu.report.SonarQubeReport.readSonarQubeResultFile;
import static edu.polyu.report.SpotBugsReport.readSingleSpotBugsResultFile;
...
//        };
    ...
    public static void invokeSonarQube(String seedPath, String mutantFolderPath) {
        ...
        readSonarQubeResultFile(seedPath, output);
        ...
        for (String mutantPath : mutantPaths) {
            ...
            readSonarQubeResultFile(mutantPath, output);
