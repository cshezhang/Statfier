...
class TestInvalidLogMessageFormat {
    ...
    protected void logProblem(String type, java.lang.Object val) {
        ...
        if (log.isDebugEnabled()) {
            /*whistled, fp*/ log.debug("Recurring {} reading {} in {} (still in grace period): {}", new java.lang.Object[] {type, this, getBriefDescription(), val});
        }
    }
