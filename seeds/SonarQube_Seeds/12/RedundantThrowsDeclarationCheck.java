...
public class RedundantThrowsDeclarationCheck {
  ...
  public void foo11()
      throws MyException,
          MyException { // Noncompliant {{Remove the redundant
  ...
  public void foo13()
      throws MyRuntimeException,
          MyRuntimeException { // Noncompliant {{Remove the redundant
...
abstract class ThrownCheckedExceptions extends MySuperClass {
  public ThrownCheckedExceptions(String s)
      throws
          MyException { // Noncompliant [[sc=51;ec=62;quickfixes=qf_all_throws]] {{Remove the
  ...
  void foo0()
      throws
          MyException { // Noncompliant {{Remove the declaration of thrown exception
...
class RedundantThrowsDeclarationChild extends RedundantThrowsDeclarationParent {
  ...
  public RedundantThrowsDeclarationChild(Integer a, Integer b)
      throws
          IllegalAccessException { // Compliant, call to Parent that calls foo, that thows
