...
class BigDecimalDoubleConstructorCheck {
  ...
  BigDecimal bd4 =
      new BigDecimal(
          2.0,
          mc); // Noncompliant [[sc=20;ec=43;quickfixes=qf1_2]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
  ...
  BigDecimal bd43 =
      new BigDecimal(
          123.0,
          mc); // Noncompliant [[sc=21;ec=46;quickfixes=qf1_3]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
  ...
  BigDecimal bd6 =
      new BigDecimal(
          2.0f,
          mc); // Noncompliant [[sc=20;ec=44;quickfixes=qf1_4]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
  ...
  BigDecimal bd6_2 =
      new BigDecimal(
          2.0d,
          mc); // Noncompliant [[sc=22;ec=46;quickfixes=qf1_5]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
  ...
  BigDecimal bd6_3 =
      new BigDecimal(
          2.0F,
          mc); // Noncompliant [[sc=22;ec=46;quickfixes=qf1_6]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
  ...
  BigDecimal bd6_4 =
      new BigDecimal(
          2.0D,
          mc); // Noncompliant [[sc=22;ec=46;quickfixes=qf1_7]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
  ...
  BigDecimal bd8_3 =
      new BigDecimal(
          d,
          mc); // Noncompliant [[sc=22;ec=43;quickfixes=!]] {{Use "new BigDecimal(String,
               // MathContext)" instead.}}
