...
enum Continent {
  ...
  public void setLandMass1(
      int
          landMass) { // Noncompliant [[sc=3;ec=9]] {{Lower the visibility of this setter or remove
                      // it altogether.}}
  ...
  public void setLandMass2(
      int
          landMass) { // compliant: empty setter is harmless : this can be a pattern used when
