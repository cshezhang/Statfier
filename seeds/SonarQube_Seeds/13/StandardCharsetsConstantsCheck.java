...
class StandardCharsetsConstantsCheck {
  ...
  void myMethod() throws Exception {
    ...
    Charset.forName(
        "ISO-8859-1"); // Noncompliant {{Replace Charset.forName() call with
                       // StandardCharsets.ISO_8859_1}} [[sc=5;ec=34]]
    Charset.forName(
        "ISO_8859_1"); // Noncompliant {{Replace Charset.forName() call with
                       // StandardCharsets.ISO_8859_1}}
    Charset.forName(
        "US-ASCII"); // Noncompliant {{Replace Charset.forName() call with
                     // StandardCharsets.US_ASCII}}
    Charset.forName(
    ...
    Charset.forName(
        "UTF-16BE"); // Noncompliant {{Replace Charset.forName() call with
                     // StandardCharsets.UTF_16BE}}
    Charset.forName(
        "UnicodeBigUnmarked"); // Noncompliant {{Replace Charset.forName() call with
                               // StandardCharsets.UTF_16BE}}
    Charset.forName(
        "UTF-16LE"); // Noncompliant {{Replace Charset.forName() call with
                     // StandardCharsets.UTF_16LE}}
    Charset.forName(
        "UnicodeLittleUnmarked"); // Noncompliant {{Replace Charset.forName() call with
                                  // StandardCharsets.UTF_16LE}}
    Charset.forName(
    ...
    org.apache.commons.io.IOUtils.toString(
        bytes,
        "UTF-8"); // Noncompliant {{Replace IOUtils.toString() call with new String(...,
