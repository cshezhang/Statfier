...
public abstract class XmlInjection {
  ...
  public String goodXmlStringParam(String amount) {
    String xmlString =
        "<b><a href=\"search?amount=" + Encode.forHtmlAttribute(amount) + "\">Click Me</a></b>";
    return xmlString;
  }
  ...
  public String badXmlStringFunction2() {
    String xmlString =
        "<product>\n<name>Cellphone</name>\n<price>"
            + StringEscapeUtils.escapeHtml(unreliableAmount())
            + "</price>\n<amount>"
            + unreliableAmount()
            + "</amount></product>";
    return xmlString;
  ...
  public String goodXmlStringFunction2() {
    String xmlString =
        "<product>\n<name>Cellphone</name>\n<price>800</price>\n<amount>"
            + StringEscapeUtils.escapeXml(unreliableAmount())
            + "</amount></product>";
    return xmlString;
  }
  ...
  public String goodXmlStringFunction3() {
    String xmlString =
        "<product>\n<name>Cellphone</name>\n<price>800</price>\n<amount>"
            + Encode.forHtml(unreliableAmount())
            + "</amount></product>";
    return xmlString;
  }
