...
/**
 * This custom error page is intended to facilitate the exploitation of the injection. Error based
 * injection is then possible and no script should be needed to extract value.
 *
 * <p>(The default error page will be too generic otherwise.)
 */
@Controller
public class VerboseErrorController implements ErrorController {
  ...
  private static final String ERROR_TEMPLATE =
      "<html><body><h1>${error.error}</h1><h2>${error.exception}</h2><p>${error.message}</p></body></html>";
