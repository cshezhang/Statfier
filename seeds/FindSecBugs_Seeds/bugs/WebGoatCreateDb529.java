  ...
  private void createTransactionTable(Connection connection) throws SQLException {
    ...
    String[] data =
        new String[] {
          ...
          "'dave', 2, '238-4723-4024', '324-7635-9867', '2008-02-20 21:42:00', 'School fees',"
              + " '150'",
          "'CEO', 3, '348-6324-9872', '345-3490-8345', '2008-02-15 21:40:00', 'Rolls Royce',"
              + " '-150000'",
          "'CEO', 4, '348-6324-9872', '342-5893-4503', '2008-02-25 21:41:00', 'Mansion', '-150000'",
          "'CEO', 5, '348-6324-9872', '980-2344-5492', '2008-02-27 21:42:00', 'Vacation',"
              + " '-150000'",
