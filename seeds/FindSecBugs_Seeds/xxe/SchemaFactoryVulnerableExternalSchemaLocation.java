...
public class SchemaFactoryVulnerableExternalSchemaLocation {
  ...
  public static void main(final String[] args) throws SAXException, IOException {
    ...
    final String documentSource =
        "<?xml version=\"1.0\"?><schema xmlns=\"http://www.w3.org/2001/XMLSchema\"><include"
            + " schemaLocation=\"file:///etc/passwd\"/></schema>";
    final ByteArrayInputStream inputStream =
        new ByteArrayInputStream(documentSource.getBytes(StandardCharsets.UTF_8));
