...
/**
 * Inspired by the gadget : SerializableTypeWrapper.MethodInvokeTypeProvider.readObject Ref:
...
public class MethodInvokeTypeProvider implements TypeProvider {
  ...
  public Type getType() {
    return !(this.result instanceof Type) && this.result != null
        ? ((Type[]) ((Type[]) this.result))[this.index]
        : (Type) this.result;
  }
