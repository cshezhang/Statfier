...
/**
 * Variation of SpringJdbcOperations. Where a call on the concrete class is made instead of the
 * interface.
 */
public class SpringJdbcTemplate {
  ...
  public void queryExecute(String sql) throws DataAccessException {
    ...
    jdbcTemplate.execute(
        new StoredProcCall(sql),
        new TestCallableStatementCallback()); // The injection is flag later (line 107)
  ...
  public void queryBatchUpdate(String sql) throws DataAccessException {
    ...
    jdbcTemplate.batchUpdate(
        sql, new ArrayList<UserEntity>(), 11, new TestParameterizedPreparedStatementSetter());
    jdbcTemplate.batchUpdate(sql, new ArrayList<Object[]>());
    jdbcTemplate.batchUpdate(
        sql, new ArrayList<Object[]>(), new int[] {Types.INTEGER, Types.VARCHAR, Types.VARCHAR});
  }
  ...
  public class TestCallableStatementCallback<UserEntity>
      implements CallableStatementCallback<UserEntity> {
    @Override
    public UserEntity doInCallableStatement(CallableStatement callableStatement)
        throws SQLException, DataAccessException {
      return null;
    }
  }

  public class TestParameterizedPreparedStatementSetter<UserEntity>
      implements ParameterizedPreparedStatementSetter<UserEntity> {

    @Override
    public void setValues(PreparedStatement preparedStatement, UserEntity o) throws SQLException {}
  }

  public class TestBatchPreparedStatementSetter<UserEntity>
