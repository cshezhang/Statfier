...
public class SafeSpringCsrfRequestMappingController {
  ...
  /**
   * Mapping to the HTTP request method `GET` is safe as long as no state-changing operations are
  ...
  /**
   * Mapping to the HTTP request method `HEAD` is safe as long as no state-changing operations are
   * performed within this method.
   */
  ...
  /**
   * Mapping to the HTTP request method `TRACE` is safe as long as no state-changing operations are
   * performed within this method.
   */
  ...
  /**
   * Mapping to the HTTP request method `OPTIONS` is safe as long as no state-changing operations
  ...
  /**
   * Mapping to several HTTP request methods is fine as long as all the HTTP request methods used
   * are unprotected.
   */
  @RequestMapping(
      value = "/request-mapping-several-unprotected-methods",
   ...
   */
  @RequestMapping(
      value = "/request-mapping-several-protected-methods",
