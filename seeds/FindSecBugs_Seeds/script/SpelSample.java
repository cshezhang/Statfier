 ...
 *
 * <p>Because each of those function have distinct bytecode used for the call to
 * "parseExpression()". One calling the interface, the abstract class and finally the concrete
 * class. We don't want to miss any of the implementations.
 */
public class SpelSample {
  ...
  public static void main(String[] args) {
    ...
    parseExpressionInterface(
        "T(java.lang.Runtime).getRuntime().exec('calc.exe')"); // start the calc virus :)
  }
