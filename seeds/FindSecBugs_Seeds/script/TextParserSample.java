...
public class TextParserSample {
  ...
  public void unsafeTextParser(
      String input, TextParser textParser, TextParseUtil.ParsedValueEvaluator parser) {
  ...
  public void unsafeOgnlTextParser(
      String input, OgnlTextParser textParser, TextParseUtil.ParsedValueEvaluator evaluator) {
    textParser.evaluate(new char[] {'a'}, input, evaluator, 0);
  }

  public void safeOgnlTextParser(
      OgnlTextParser textParser, TextParseUtil.ParsedValueEvaluator evaluator) {
    String input = "1+1";
    textParser.evaluate(new char[] {'a'}, input, evaluator, 0);
  }
  ...
  public void safeTextParseUtil(
      ValueStack stack, TextParseUtil.ParsedValueEvaluator parsedValueEvaluator, Class type) {
    String input = "1+1";
