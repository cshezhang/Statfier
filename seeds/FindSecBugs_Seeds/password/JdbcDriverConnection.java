...
public class JdbcDriverConnection {
  ...
  public static void connectionWithHardCodePassword1() throws SQLException {
    Connection conn =
        DriverManager.getConnection(
            "jdbc:mysql://prod.company.com/production", "root", "lamepassword");
  }

  public static void connectionWithHardCodePassword2() throws SQLException {
    Connection conn =
        DriverManager.getConnection(
            "jdbc:mysql://prod.company.com/production", "dba", MYSQL_PASSWORD);
  }
  ...
  public static void connectionOK(Properties props) throws SQLException {
    ...
    Connection conn =
        DriverManager.getConnection("jdbc:mysql://prod.company.com/production", username, password);
  }
}
