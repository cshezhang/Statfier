...
public class Bug1220 {
  ...
  /**
   * We get a warning here when compiled with javac, as expected. But eclipse optimizes away the
   * useless jump, so we can't detect anything. Would be nice if expectWarning to say something to
   * the effect of "Warning expected if compiled with javac", but I don't know how to detect which
   * tool generated a classfile.
   */
  @DesireWarning("UCF")
